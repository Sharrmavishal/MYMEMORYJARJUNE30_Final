...
if (savedStory.audio_url) {
  try {
    ...
    console.log('🔗 Blockchain verification:', blockchainTx)
          ...
          alert(`🎉 AI Audio Story created successfully!\n\n🎧 Listen to your narrated story below\n🔗 Blockchain verified: ${blockchainTx}`)
        } catch (error) {
...
<div style={{ 
  ...
  <button
    ...
    style={{
      padding: '10px 20px',
      background: 'rgba(255,255,255,0.2)',  // Keep transparent
      color: 'white',                       // Keep white
      border: 'none',
      borderRadius: '20px',
      cursor: 'pointer',
      fontSize: '14px',
      fontWeight: 'normal'                  // Keep normal
    }}
  >
    🎙️ Memories
  </button>
  <button
    ...
    style={{
      padding: '10px 20px',
      background: 'white',                  // Change to white (highlighted)
      color: '#667eea',                     // Change to purple
      border: 'none',
      borderRadius: '20px',
      cursor: 'pointer',
      fontSize: '14px',
      fontWeight: 'bold'                    // Change to bold
    }}
  >
    📖 Stories
  </button>
